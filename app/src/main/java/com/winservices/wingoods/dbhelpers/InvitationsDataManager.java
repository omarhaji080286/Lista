...
public class InvitationsDataManager {
    ...
    public void addReceivedInvitation(ReceivedInvitation invitation) {
        if (db.invitationExists(invitation.getInvitationPhone())) {
            ReceivedInvitation ri = db.getReceivedInvitation(invitation.getInvitationPhone());
            invitation.setReceivedInvitationId((ri.getReceivedInvitationId()));
            db.updateReceivedInvitation(invitation);
        } else {
            db.addReceivedInvitation(invitation);
