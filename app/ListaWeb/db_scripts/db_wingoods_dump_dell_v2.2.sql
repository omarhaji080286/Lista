...
--
-- Client :  127.0.0.1
-- Généré le :  Lun 10 Septembre 2018 à 12:23
...
CREATE TABLE `cities` (
  `server_city_id` int(11) NOT NULL,
  `city_name` varchar(45) NOT NULL,
  `server_country_id` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
ALTER TABLE `cities`
  ADD PRIMARY KEY (`server_city_id`,`server_country_id`),
  ADD UNIQUE KEY `server_city_id_UNIQUE` (`server_city_id`),
  ADD UNIQUE KEY `city_name_UNIQUE` (`city_name`),
  ADD KEY `fk_city_country1_idx` (`server_country_id`);

--
-- Index pour la table `countries`
--
ALTER TABLE `countries`
  ADD PRIMARY KEY (`server_country_id`),
  ADD UNIQUE KEY `server_country_id_UNIQUE` (`server_country_id`);
...
ALTER TABLE `co_users`
  ...
  ADD UNIQUE KEY `server_co_user_id_UNIQUE` (`server_co_user_id`),
...
ALTER TABLE `groups`
  ...
  ADD UNIQUE KEY `server_group_id_UNIQUE` (`server_group_id`);

--
-- Index pour la table `ordered_goods`
--
ALTER TABLE `ordered_goods`
  ADD PRIMARY KEY (`server_ordered_good_id`,`server_shop_id`,`server_order_id`,`server_user_id`,`server_shop_type_id`),
  ADD UNIQUE KEY `server_ordered_good_id_UNIQUE` (`server_ordered_good_id`),
...
ALTER TABLE `orders`
  ...
  ADD UNIQUE KEY `server_order_id_UNIQUE` (`server_order_id`),
...
ALTER TABLE `shopkeepers`
  ...
  ADD UNIQUE KEY `server_shopkeeper_id_UNIQUE` (`server_shopkeeper_id`),
...
--
ALTER TABLE `shops`
  ADD PRIMARY KEY (`server_shop_id`,`server_shop_type_id`,`server_city_id`,`server_country_id`),
  ADD UNIQUE KEY `server_shop_id_UNIQUE` (`server_shop_id`),
  ADD KEY `fk_stores_store_types1_idx` (`server_shop_type_id`),
  ADD KEY `fk_shops_city1_idx` (`server_city_id`,`server_country_id`);
...
ALTER TABLE `shop_types`
  ...
  ADD UNIQUE KEY `server_shop_type_id_UNIQUE` (`server_shop_type_id`);
...
--
ALTER TABLE `cities`
  MODIFY `server_city_id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT pour la table `countries`
--
ALTER TABLE `countries`
  MODIFY `server_country_id` int(11) NOT NULL AUTO_INCREMENT;
--
...
--
ALTER TABLE `cities`
  ADD CONSTRAINT `fk_city_country1` FOREIGN KEY (`server_country_id`) REFERENCES `countries` (`server_country_id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
...
--
ALTER TABLE `shops`
  ADD CONSTRAINT `fk_shops_city1` FOREIGN KEY (`server_city_id`,`server_country_id`) REFERENCES `cities` (`server_city_id`, `server_country_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
